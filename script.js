document.addEventListener('DOMContentLoaded', () => {
    ...
    async function initializeApp(user) {
        ...
        // --- Event Listeners ---
        addClinicBtn.addEventListener('click', () => { clinicForm.reset(); document.getElementById('modal-title').textContent = '의원 정보 입력'; document.getElementById('clinic-id').value = ''; modal.classList.remove('hidden'); });
